...
public class PlayerController implements Initializable {
    ...
    private static final double MIN_CHANGE = 1000 ;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ChangeListener<Number> lambdaChangeListener = (ObservableValue<? extends Number> observable, Number oldValue, final Number newValue) -> {
            System.out.println("ITS HAPPENING " + newValue + " " + oldValue);
            
        };
        //this.timeSlider.valueChangingProperty().addListener(listener);
        //this.timeSlider.().addListener(lambdaChangeListener);
        //this.timeSlider.valueProperty().addListener(lambdaChangeListener);
        //this.timeSlider.getOnDragEntered()
        ...
        this.timeSlider.valueChangingProperty().addListener(new ChangeListener<Boolean>() {
            @Override
            public void changed(
                    ...
                    Boolean changing) {
                if (changing) {
                    System.out.println("Sliding starting");
                    isBeingDragged = true;
                } else {
                    System.out.println("Sliding ending");
                    updateSongPosition();
    ...
    private void updateSongPosition(){
        Duration seekTo = new Duration(this.timeSlider.getValue());
